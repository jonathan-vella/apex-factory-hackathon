...
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind("Name,Budget,StartDate,InstructorID")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind("DepartmentID,Name,Budget,StartDate,InstructorID,RowVersion")] Department department)
        {
            try
            {
                if (ModelState.IsValid)
