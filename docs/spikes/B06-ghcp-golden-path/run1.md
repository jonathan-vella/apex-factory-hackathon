...
| 2 C3 assess | 11:03 | 11:32 | Extension default, not selectable (dashboard, Local harness) | Custom assessment, target App Service for Linux (containers); every other option at its default (owner confirmed) | Assessment report (`assessment/run1/`) | None | — | not visible |
